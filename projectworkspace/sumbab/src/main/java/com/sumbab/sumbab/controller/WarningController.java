...
public class WarningController {
	...
	//여기서부터는 회원이 신고할 때 동작
	@RequestMapping(value="/storeMerge/warningProcess/{reviewNum}", method=RequestMethod.GET)
	public String warningProcess(Model model, HttpSession session) {		
	...
	@RequestMapping(value="/storeMerge/warningProcess/{reviewNum}", method=RequestMethod.POST)
	public String insert(@PathVariable int reviewNum, HttpSession session, Warning warning) {
