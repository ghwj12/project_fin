...
<body>
	...
	<c:otherwise>
		...
		<input type="button" value="로그인 하기" onclick="javascript:opener.location.href='/sumbab/login/login';self.close()">
	</c:otherwise>
	</c:choose>
	<input type="button" class="button" value="보관함으로 이동" onclick="javascript:opener.location.href='/sumbab/pick/storage';self.close()">
