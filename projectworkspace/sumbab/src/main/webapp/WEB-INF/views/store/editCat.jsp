...
<c:choose>
	...
	<div>숨밥 카테고리 기반 추천에 가게를 노출 하려면, 아래 항목을 선택해주세요.<br>
		선택하지 않을 경우, 카테고리 추천에 나타나지 않을 수 있습니다.<br><br><br>
	</div>
...
<br>
		<div>
			<h5>어느 시간대에 먹기 적합한가요? (중복 선택 가능)</h5>
		</div>
...
<br>
		<div>
			<h5>어떤 음식을 먹고 싶을 때 가기 적합한가요? (중복 선택 가능)</h5>
		</div>
		...
		<input type="button" class="button" value="취소" onclick="location.href='/sumbab/store/myStoreList'">
	</form:form>
	</c:when>
<%--cafe category ============================= --%>
	<c:otherwise>
