...
<form:form method="get" action="/sumbab/store/editStore/${store.storeNum}" commandName="storeVO" enctype="multipart/form-data">
	...
	<input type="submit" class="button" value="가게정보 수정하기">
	<input type="button" class="button" value="가게 삭제하기" onclick="location.href='/sumbab/store/deleteStoreProc/${store.storeNum}'">
</form:form>
<br><br><br>

<h2>"${store.name}"의 설정 카테고리</h2>
<c:choose>
...
<form:form method="get" action="/sumbab/store/editCat/${store.storeNum}" commandName="restCatVO" enctype="multipart/form-data">
	...
	<input type="submit" class="button" value="카테고리 수정하기">
</form:form>
	</c:when>
